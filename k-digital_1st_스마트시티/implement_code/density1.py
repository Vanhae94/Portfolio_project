...
# 영상 파일 로드
video_path = r"D:\cctv_project\video\video_20.mp4"  # 입력 영상 파일 경로
...
def select_area(event, x, y, flags, param):
    ...
    elif event == cv2.EVENT_RBUTTONDOWN:  # 우클릭으로 선택 취소
        start_point = None
        end_point = None
        selected_area_set = False
        locked_area = None
...
# OpenCV 창에 마우스 콜백 연결
cv2.namedWindow("Select Area",cv2.WINDOW_NORMAL) # 두번째 속성으로 창크기 자유롭게 조절가능
